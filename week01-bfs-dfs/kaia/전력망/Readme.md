...
2026년 07월 23일 23:57:19


### 접근법

1. 전선 하나를 끊으면 전력망이 두 덩어리로 나뉜다.
2. 모든 전선을 하나씩 끊어 본다.
3. 끊은 전선을 제외한 나머지 전선으로 그래프를 만든다.
4. 아무 송전탑에서 BFS를 시작해, 연결된 송전탑 수를 센다.
5. BFS로 센 송전탑 수가 한쪽 전력망의 크기이고, 다른 한쪽의 크기는 n-count이다.
6. 두 전력망 송전탑 수의 차이를 구하고, 그중 가장 작은 값을 answer에 저장한다.
